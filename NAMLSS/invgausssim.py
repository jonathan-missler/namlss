...
Ydist = tfp.distributions.InverseGaussian(loc=tf.exp(x), concentration=2*tf.exp(x))
...
plt.scatter(train_features[:, 0], shape_pred, color="green", alpha=0.7, s=1.5)
